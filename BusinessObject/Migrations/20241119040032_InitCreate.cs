...
namespace BusinessObject.Migrations
{
    public partial class InitCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubcriptionsId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Subcriptions_SubcriptionsId",
                        column: x => x.SubcriptionsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Flaged = table.Column<bool>(type: "boolean", nullable: false),
                    ApplicationUsersId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tasks_Users_ApplicationUsersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_SubcriptionsId",
                table: "Orders",
                column: "SubcriptionsId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "UserSubcriptions");
            migrationBuilder.DropTable(name: "Tags");
            migrationBuilder.DropTable(name: "Tasks");
            migrationBuilder.DropTable(name: "Subcriptions");
